...
def get_weather():
    ...
    try:
        ...
        # Weather
        api = f"http://api.openweathermap.org/data/2.5/onecall?lat={location.latitude}&lon={location.longitude}&exclude=hourly,minutely&appid=8b582028d93ec5f38564dcf1afe51efa&units=metric"
